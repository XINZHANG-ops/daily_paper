...
Agent evaluation has emerged as a critical challenge as autonomous AI systems become capable of complex multi-step tasks. Two recent papers (2604.06132 and 2604.08523) expose fundamental weaknesses in current benchmark methodologies and demonstrate that impressive performance on existing benchmarks dramatically underestimates the difficulty of real-world deployment. The findings reveal that evaluation methodology—not just task design—is the key variable determining whether benchmarks measure genuine capability or artifact.
