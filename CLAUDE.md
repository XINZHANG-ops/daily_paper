...
This project is indexed by GitNexus as **daily_paper** (2860 symbols, 3857 relationships, 95 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/daily_paper/context` | Codebase overview, check index freshness |
| `gitnexus://repo/daily_paper/clusters` | All functional areas |
| `gitnexus://repo/daily_paper/processes` | All execution flows |
| `gitnexus://repo/daily_paper/process/{name}` | Step-by-step execution trace |
